...
android {
    namespace = "com.aifranchise"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.aifranchise"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    signingConfigs {
        create("release") {
            storeFile = file("franchise-release-key.jks")
            storePassword = "Franchise@123"
            keyAlias = "franchisekey"
            keyPassword = "Franchise@123"
        }
    }
